...
const ColorPicker = ({
  ...
  return (
    <div className="relative flex items-center w-full justify-between gap-5">
      ...
      <div
        className="cursor-pointer rounded w-16 h-7"
...
const PrefabricatedPalettePicker = ({
  className,
  palette,
  setOptions,
}: {
  ...
  return (
    <div
      onClick={onClick}
      className={`cursor-pointer rounded w-12 h-full bg-gradient-to-b ${className}`}
    ></div>
  )
}
  ...
  return (
    <>
      ...
      <div className="flex flex-col bg-neutral-800 mt-5 rounded-xl px-10">
          ...
          <div className="flex flex-col gap-3 w-min">
            <div className="flex items-center justify-end gap-5">
              ...
              <input
                ...
                min="0"
                max="50"
                value={_options.outlineWidth}
                onChange={onChange('outlineWidth')}
              />
              {_options.outlineWidth}
            </div>
            <ColorPicker name="Outline" color={_options.outlineColor}>
              <HexColorPicker
                color={_options.outlineColor}
                onChange={handleChangeComplete('outlineColor')}
              />
            </ColorPicker>
          </div>
        </div>
        ...
        <div className="flex py-7">eventHandlers [TODO]</div>
      </div>
    </>
  )
}
