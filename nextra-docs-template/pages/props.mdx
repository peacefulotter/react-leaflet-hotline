...
| max    |  number   |   1 | <span className='text-2xl font-bold text-orange-500'>&#126;</span> (Recommended) | <span className='text-2xl text-green-500'>✔</span> | Maximum value of your data, `max` will correspond to the color at 1 on the palette  |
